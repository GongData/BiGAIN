...
### Dynamic_rnn change to Bidirectional_dynamic_rnn  
Adjust code in WGAN_GRUI.py (Bidirectional dynamic rnn)
Ajust code in WGAN_GRUI.py ( Jensen-Shannon Divergence)


max auc is: 0.8230488647155315
